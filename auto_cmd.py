...
while True:
    user_query = input("Enter your query (or type 'thank_you' to stop): ")
    ...
    try:
        ...
        print("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
        for i in sql_query.values():
            print(i)
        print("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
        
        try:
            query_result = db_connector.hit_sql(sql_query['Final SQL'])
            print(f"Query Result: ",query_result)#{query_result.to_dict(orient='records')}")
